...
phy<-qza_to_phyloseq(features="filtered.merge.table.two.qza", tree="rooted-tree.qza", taxonomy="taxonomy.two.qza",metadata="MSQ.mouse.master.map.two.txt")
...
save.image(file="191017.short.RData")
load(file="191017.short.RData")
